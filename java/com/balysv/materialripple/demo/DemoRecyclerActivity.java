...
public class DemoRecyclerActivity extends ActionBarActivity {
    ...
    private static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public void onClick(View v) {
            Toast.makeText(v.getContext(), "Rippled item: " + getPosition(), Toast.LENGTH_SHORT).show();
        }

        @Override
        public boolean onLongClick(View v) {
            if (getPosition() % 2 == 0) {
                Toast.makeText(v.getContext(), "long item: " + getPosition() + " and not consumed",
                    Toast.LENGTH_SHORT)
                    .show();
                return false;
            }
            Toast.makeText(v.getContext(), "long item: " + getPosition() + " and consumed", Toast.LENGTH_SHORT)
                .show();
            return true;
        }
    }
